...
public class EuropeanServer {
	...
	public static void main(String[] args) {
		...
		try {
			...
			startRegistry(EU_REGISTRY_PORT);

			logger.write(">>> Create European Server Object");
			EuropeanServerImpl EUServer = new EuropeanServerImpl();

			logger.write(">>> Binding " + registryURL + " at " + EU_REGISTRY_PORT);
			logger.write(">>> rmi://localhost:" + EU_REGISTRY_PORT + "/" + registryURL);
			Naming.rebind("rmi://localhost:" + EU_REGISTRY_PORT + "/" + registryURL, EUServer);
